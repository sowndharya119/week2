...
## Repository Contents
week2/ ├── model.ipynb # Jupyter Notebook (training + evaluation) ├── requirements.txt # Python dependencies ├── README.md # Project documentation
https://drive.google.com/drive/u/0/folders/1xj5K27-cdU360dl8QEE0p5ETMm3jx5qM
...
dataset/ ├── battery ├── biological ├── cardboard ├── clothes ├── green-glass ├── metal ├── paper ├── plastic ├── trash
...
Extract it into a folder named dataset/
Open model.ipynb in Jupyter Notebook / Google Colab
Run all cells to: ✅ Load dataset ✅ Train CNN model ✅ Evaluate model accuracy
Improvements Done by Me (as required by Week 2 task)
✅ Data augmentation applied ✅ Used train-test split for fair evaluation ✅ Added dropout to reduce overfitting ✅ Used Google Drive dataset link due to GitHub upload limit ✅ Organized project into clean folder structure
